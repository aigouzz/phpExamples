...
$name = 'ggg';
$age = 14;
echo "do you have a $name;and $age;";
//for test

echo '<br />';
echo "actually it is a '".$name."'";
$arr = array('name','age');
if(in_array('name',$arr)){
    echo '<br />'.'name is in array $arr';
}
...
<head>
    ...
    <script>
        var name = 'ddz';
        var arr = 'name is not so important,ddz is good!';
        var re = /\d/g;
        if(re.test(arr)){
            alert('pass');
        }else{
...
<script>
    ...
    console.log(map(array1,function (x) {
        return x + 1;
    }));
</script>
</body>
